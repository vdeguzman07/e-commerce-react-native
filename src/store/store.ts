          ...
          produce(state => {
            ...
            for (let i = 0; i < state.CartList.length; i++) {
              ...
              for (let j = 0; j < state.CartList[i].prices.length; j++) {
                tempprice =
                  tempprice +
                  Number(state.CartList[i].prices[j].price.replace(/,/g, '')) *
                    state.CartList[i].prices[j].quantity;
              }
      ...
      addToFavoriteList: (type: string, id: string) =>
        set(
          produce(state => {
            ...
            console.log(type, id, 'AYDI');
            if (type == 'Coffee') {
              for (let i = 0; i < state.CoffeeList.length; i++) {
                if (state.CoffeeList[i].id == id) {
                  console.log(state.CoffeeList[i]);
                  ...
                  console.log(state.CoffeeList[i].favourite, 'VALUEEE');
                  break;
                }
              }
            } else if (type == 'Bean') {
